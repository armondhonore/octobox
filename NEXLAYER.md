...
**Live:** [https://relaxed-weasel-octobox.cloud.nexlayer.ai](https://relaxed-weasel-octobox.cloud.nexlayer.ai)  
...
**octobox** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
  - name: app
    image: mirror.gcr.io/octoboxio/octobox:latest
    path: /
    servicePorts:
    - 3000
    vars:
      ...
      DATABASE_URL: "postgresql://octobox:${POSTGRES_PASSWORD}@postgres.pod:5432/octobox"
